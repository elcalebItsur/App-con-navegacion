...
function Semana({laboral=false,diasSeleccionados = [false,false,false,false,false,false,false],extendida=false, cambioDeDia, readOnly=false}) {
    let dias=['Lunes','Martes','Miercoles','Jueves','Viernes','Sabado','Domingo'];
        ...
        const clickDia=(indice)=>{
            ...
            let nuevosChecked=[...checked]; // Crea una copia del arreglo checked para evitar mutar el estado directamente
            nuevosChecked[indice]=!nuevosChecked[indice]; // Cambia el valor del día seleccionado al contrario de su estado actual
